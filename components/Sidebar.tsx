...
import {
  ImageIcon, VideoIcon, SettingsIcon, BookOpenIcon, LogoutIcon, GalleryIcon, XIcon, LibraryIcon, FileTextIcon, GraduationCapIcon, TrendingUpIcon, RobotIcon, MegaphoneIcon, DatabaseIcon, WhatsAppIcon
} from './Icons';
...
const getNavItems = (): NavItem[] => {
    const supportUrl = MASTER_CONFIG.supportUrl || '#';
    const supportUrlLabel = MASTER_CONFIG.supportUrlLabel || 'Support Group';
    ...
    return [
      ...
      { id: 'support-group', label: supportUrlLabel, section: 'bottom', icon: WhatsAppIcon, isExternal: true, url: supportUrl },
    ...
    <>
      ...
      >
        <div className="mb-8 flex items-center justify-between">
            <DynamicLogo className="w-40 text-neutral-800 dark:text-neutral-200" />
        ...
        <div className="mt-auto pt-4 border-t border-neutral-200 dark:border-neutral-800">
          ...
          <p className="mt-4 text-center text-neutral-500 dark:text-neutral-600 text-xs">© 2025 {appName} ({APP_VERSION})</p>
        </div>
      </nav>
    </>
  );
