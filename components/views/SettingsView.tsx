...
import {
    ...
    AlertTriangleIcon, DatabaseIcon, TrashIcon, RefreshCwIcon, WhatsAppIcon, InformationCircleIcon, SparklesIcon, ServerIcon
} from '../Icons';
...
const ApiIntegrationsPanel: React.FC<ApiIntegrationsPanelProps> = ({ currentUser, onUserUpdate, language, veoTokenRefreshedAt, assignTokenProcess }) => {
    ...
    const handleHealthCheck = async () => {
        ...
        try {
            const activeApiKey = sessionStorage.getItem(`${MASTER_CONFIG.appName}_session_api_key`);
    ...
    return (
        <>
            ...
            <div className="bg-white dark:bg-neutral-900 p-6 rounded-lg shadow-sm space-y-8">
                <div>
                    <h2 className="text-xl font-semibold mb-2">{MASTER_CONFIG.appName} API Key</h2>
                ...
                <div className="border-t border-neutral-200 dark:border-neutral-800 pt-8">
                    <h2 className="text-xl font-semibold mb-2">{MASTER_CONFIG.appName} Auth Token</h2>
