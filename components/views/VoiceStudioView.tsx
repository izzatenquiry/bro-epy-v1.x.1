        ...
        <>
            ...
            {audioUrl && audioBlob && (
                <div className="flex flex-col items-center justify-center h-full gap-6">
                    ...
                    <a href={audioUrl} download={`${MASTER_CONFIG.appName?.replace(/\s/g, '-')}-voiceover-${Date.now()}.wav`} className="flex items-center gap-2 bg-green-600 text-white font-semibold py-2 px-6 rounded-lg hover:bg-green-700 transition-colors">
