...
const TUTORIAL_CONTENT_KEY = 'app-tutorial-content';
const PLATFORM_STATUS_KEY = 'app-platform-status';
const ANNOUNCEMENTS_KEY = 'app-announcements';

const defaultTutorialContent: TutorialContent = {
  mainVideoUrl: 'https://www.youtube.com/embed/dQw4w9WgXcQ',
  mainTitle: 'Welcome to the AI Content Platform',
  mainDescription: 'This video is your introduction to the platform. Understand the overview, powerful features, and how to get started on your creative projects with the help of AI.',
  tutorials: [
...
const defaultAnnouncements: Announcement[] = [
    {
        ...
        content: 'We are excited to launch this all-new AI platform. Explore the features and start creating today.',
        category: 'General',
...
export const getViralPrompts = async (): Promise<ViralPrompt[]> => {
    const { data, error } = await supabase
        .from(TABLE_NAMES.VIRAL_PROMPTS)
        .select('*')
